  ...
  function Footer() {
    ...
    return (
      <footer className="flex flex-col mt-0 items-center px-20 pt-10 pb-8 bg-[#5388AA] max-md:px-5">
        ...
        <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/d7477276369ec6f3262942f32bbf6e00762c43cc2fe8dc2d6dacd445535c0acd?apiKey=086f9e918f6c40cfbf2a7915a1bfe439&" alt="Logo" className="shrink-0 max-w-full aspect-[2.86] w-[129px] -translate-y-3" />
        <nav className="flex lg:grid-cols-2 lg:grid lg:gap-10 gap-20 self-stretch my-auto list-none" >
        {Links.map((link) => (
