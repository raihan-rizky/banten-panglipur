        ...
        <>
            <div className="overflow-hidden xl-max:flex-col xl-max:items-center -translate-y-20 relative flex max-w-full min-h-[808px] bg-gradient-to-b from-[#87C0CD] to-white">
                <div className='max-w-full'>
                    <img className='absolute -translate-x-[150px] translate-y-[70px]' src='./public/images/backgound_logo.png' />
                </div>
                <div className="relative z-10 flex flex-col items-center h-full text-justify text-black px-4 mt-[150px]">
                    <h1 className="max-w-[392px] min-h-[68px] font-[700] text-[40px] text-center mb-5 font-extrabold tracking-[9.6px]">BANTEN <br />PANGLIPUR</h1>
                    <p className="max-w-[900px] min-h-[100px] font-[400] text-[20px]">
                        "Banten Panglipur" adalah sebuah platform daring yang mempersembahkan kekayaan wisata dan budaya yang dimiliki oleh daerah Banten. Melalui situs ini, pengunjung dapat menjelajahi beragam destinasi wisata yang menakjubkan serta merasakan keindahan dan keunikannya. Dari pantai yang memikat hingga situs sejarah yang kaya akan cerita, Banten Panglipur menghadirkan pengalaman yang memukau bagi para pengunjung. <br /><br />
