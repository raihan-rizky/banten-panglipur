        ...
        <>
                ...
                <div className='justify-between xl-max:flex-col max-w-full min-h-[808px]' >
                    <div className='max-w-full' data-aos='fade-down-right' >
                        <img className='relative -left-56 -bottom-6 animate-spin-slow' src='./public/images/ellipse-pattern.png'/>
                    </div>
                    <div className='max-w-full' data-aos='fade-up-left'>
                        <img className='relative left-[80rem] right-0 animate-spin-slow ' src='./public/images/ellipse-pattern.png'/>
                    </div>
                </div>
