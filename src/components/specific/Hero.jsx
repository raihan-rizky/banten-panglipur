        ...
        <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img src="./public/images/banten-hero-bg.png" className="d-block  object-cover min-h-[832px]" alt="Slide 1" />
            </div>
            <div className="carousel-item">
              <img src="./public/images/banten-hero-bg2.png" className="d-block  object-cover min-h-[832px]" alt="Slide 2" />
            </div>
            <div className="carousel-item">
              <img src="./public/images/banten-hero-bg3.png" className="d-block  object-cover min-h-[832px]" alt="Slide 3" />
            </div>
          </div>
        </div>
      </div>
