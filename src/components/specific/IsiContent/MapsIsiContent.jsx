            ...
            <div className='relative max-w-full h-auto mb-20'>
                ...
                <div className='gap-10 grid grid-cols-5 pl-56 items-center justify-center lg:grid-cols-1 lg:pl-0'>
                    ...
                    <picture className="col-span-2 lg:col-span-1">
                        <img className="relative col-span-2 z-10" src="/images/map-template.png" />
                    </picture>
                    ...
                    <div className="pr-20 col-start-4 lg:pr-0 lg:col-start-1">
                        <picture className="flex flex-col gap-8 py-10 vs-max:gap-4 max-w-full w-1/4 h-auto lg:w-full lg:flex-row lg:justify-center">
                            <img className="max-w-[109px] max-h-[52px] aspect-video" src='/images/map-icon.png' />
                            <img className="max-w-[109px] max-h-[52px] aspect-video" src='/images/share-icon.png' />
                            <img className="max-w-[109px] max-h-[52px] aspect-video" src='/images/save-icon.png' />
                        </picture>
                    </div>
                </div>
