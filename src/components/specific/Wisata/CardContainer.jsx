...
const VerticalCard = ({ id, title, description, image, onClick }) => {
    ...
    return (
        <div onClick={() => onClick(id)} className="cursor-pointer bg-white shadow-lg rounded-lg overflow-hidden flex flex-col sm:flex-row mb-5 w-full max-w-3xl">
...
const HorizontalCard = ({ id, title, image, onClick }) => {
    return (
        <div onClick={() => onClick(id)} className="cursor-pointer relative bg-white shadow-lg rounded-lg overflow-hidden h-[200px] w-[300px]">
